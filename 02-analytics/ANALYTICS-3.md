...
| Metric                            | Count                               |
| --------------------------------- | ----------------------------------- |
| Total custom events defined       | 116                                 |
| Events wired and sending          | 107                                 |
| Events defined but NOT wired      | 9 (intentional — see section below) |
...
|     | **ONBOARDING (FLUJO NUEVO)**            | Onboarding          |           | Eventos `onboarding_*` — rama new-onboarding (15 pasos). Ver `onboarding_flow.md` | |
| 17 | `onboarding_started` | Onboarding | **Wired** | `entry_point` | Step 1 Welcome — al montar |
| 18 | `onboarding_step_viewed` | Onboarding | **Wired** | `step`, `step_name` | Al montar cada pantalla del flujo |
| 19 | `onboarding_step_completed` | Onboarding | **Wired** | `step`, `step_name`, `time_on_screen_ms` | Al pulsar el CTA / avanzar |
| 20 | `onboarding_step_skipped` | Onboarding | **Wired** | `step`, `step_name` | Al saltar (login en step 1, omitir permiso) |
| 21 | `onboarding_answer_selected` | Onboarding | **Wired** | `field`, `value` | Al elegir respuesta del cuestionario (steps 3,4,6,7,8,9) |
| 22 | `onboarding_recommendation_fetched` | Onboarding | **Wired** | `primary_program_id`, `alternative_program_id`, `latency_ms`, `had_error` | Step 10 — respuesta del backend de recomendación |
| 23 | `onboarding_program_selected` | Onboarding | **Wired** | `program_id`, `is_alternative` | Step 10 — elige programa recomendado o alternativo |
| 24 | `onboarding_register_attempt` | Onboarding | **Wired** | `method` | Step 12 — inicia registro (google/apple/email) |
| 25 | `onboarding_register_success` | Onboarding | **Wired** | `method`, `time_on_screen_ms` | Step 12 — registro completado |
| 26 | `onboarding_register_failed` | Onboarding | **Wired** | `method`, `error_message` | Step 12 — registro falla |
| 27 | `onboarding_paywall_viewed` | Onboarding | **Wired** | `entry_point` (=onboarding) | Step 14 — ve el paywall (PaywallScreen) |
| 28 | `onboarding_purchase_completed` | Onboarding | **Wired** | — | Step 14 — compra / trial completado |
| 29 | `onboarding_purchase_failed` | Onboarding | **Wired** | — | Step 14 — compra falla |
| 30 | `onboarding_purchase_cancelled` | Onboarding | **Wired** | — | Step 14 — cancela el paywall |
| 31 | `onboarding_health_granted` | Onboarding | **Wired** | — | Step 13 — concede permisos de salud (cuentapasos) |
| 32 | `onboarding_health_skipped` | Onboarding | **Wired** | — | Step 13 — omite permisos de salud |
| 33 | `onboarding_notifications_granted` | Onboarding | **Wired** | — | Step 15 — concede notificaciones |
| 34 | `onboarding_notifications_skipped` | Onboarding | **Wired** | — | Step 15 — omite notificaciones |
| 35 | `onboarding_completed` | Onboarding | **Wired** | `total_time_ms`, `health_granted`, `notifications_granted`, `program_selected` | Step 15 — fin del onboarding → Home |
| 36 | `onboarding_resumed` | Onboarding | **Wired** | `step` | Al reanudar el onboarding tras cerrar la app |
|     | **TRAINING**                            |                     |           |                                                                                  |                                                                                                         |
| 37 | `program_view`                          | Training            | **Wired** | `program_id`, `program_name`, `content_type`                                     | User views program detail                                                                               |
| 38 | `program_video_play`                    | Training            | Not wired | —                                                                                | Watches program intro video                                                                             |
| 39 | `program_enroll`                        | Training            | **Wired** | `program_id`, `program_name`, `entry_point`, `location`, `level`, `program_type` | `training_providers.dart` — subscribeToProgramNotifier                                                  |
| 40 | `program_complete`                      | Training            | **Wired** | `program_id`, `program_name`, `total_days`                                       | `training_complete_screen.dart` — _logAnalytics()                                                       |
| 41 | `program_unenroll`                      | Training            | **Wired** | `program_id`, `program_name`                                                     | `training_providers.dart` — unsubscribeFromProgram                                                      |
| 42 | `training_session_start`                | Training            | **Wired** | `program_id`, `day_name`, `week_number`                                          | Starts a training day                                                                                   |
| 43 | `training_session_complete`             | Training            | **Wired** | `day_name`, `program_id`, `week_number`                                          | `training_complete_screen.dart` — _logAnalytics()                                                       |
| 44 | `training_session_rate`                 | Training            | **Wired** | `program_id`, `rating`, `perceived_effort`                                       | Rates session difficulty                                                                                |
| 45 | `exercise_start`                        | Training            | **Wired** | `exercise_id`, `exercise_name`, `program_id`                                     | Opens exercise detail                                                                                   |
| 46 | `exercise_set_log`                      | Training            | **Wired** | `exercise_id`, `exercise_name`, `set_number`, `weight`, `reps`                   | Logs a set                                                                                              |
| 47 | `exercise_video_play`                   | Training            | **Wired** | `exercise_id`, `exercise_name`                                                   | Watches exercise demo video                                                                             |
| 48 | `exercise_history_view`                 | Training            | **Wired** | `exercise_id`, `exercise_name`                                                   | Views exercise PR/history                                                                               |
| 49 | `training_tab_select`                   | Training            | **Wired** | `tab_name`                                                                       | Switches training tab                                                                                   |
| 50 | `catalog_filter_apply`                  | Training            | **Wired** | `gender`, `location`, `level`, `objective`                                       | Applies catalog filters                                                                                 |
| 51 | `training_location_select`              | Training            | **Wired** | `location`                                                                       | Selects training location                                                                               |
| 52 | `continuation_program_view`             | Training            | Not wired | —                                                                                | Views continuation suggestion                                                                           |
| 53 | `continuation_reminder_set`             | Training            | Not wired | —                                                                                | Sets continuation reminder                                                                              |
| 54 | `program_completion_archive`            | Training            | **Wired** | `program_id`, `program_name`                                                     | Archives completed program from entreno card                                                            |
| 55 | `program_completion_restart`            | Training            | **Wired** | `program_id`, `program_name`                                                     | Restarts completed program from entreno card                                                            |
| 56 | `program_completion_start_continuation` | Training            | **Wired** | `continuation_program_id`, `continuation_program_name`                           | `completed_program_screen.dart`                                                                         |
|     | **PEDOMETER / STEPS**                   |                     |           |                                                                                  |                                                                                                         |
| 57 | `pedometer_state_change`                | Pedometer           | **Wired** | `enabled`, `source`                                                              | User enables/disables steps                                                                             |
| 58 | `pedometer_sync_success`                | Pedometer           | **Wired** | `steps`, `calories`, `source`                                                    | Data synced to backend                                                                                  |
| 59 | `pedometer_permission_granted`          | Pedometer           | **Wired** | —                                                                                | `home_providers.dart` — enablePedometer() success                                                       |
| 60 | `pedometer_permission_denied`           | Pedometer           | **Wired** | —                                                                                | `home_providers.dart` — enablePedometer() failure                                                       |
|     | **EXPLORE / CONTENT**                   |                     |           |                                                                                  |                                                                                                         |
| 61 | `recipe_view`                           | Explore             | **Wired** | `recipe_id`, `recipe_name`, `content_type`                                       | Opens recipe detail                                                                                     |
| 62 | `recipe_favorite`                       | Explore             | **Wired** | `recipe_id`, `recipe_name`                                                       | Favorites a recipe                                                                                      |
| 63 | `recipe_unfavorite`                     | Explore             | **Wired** | `recipe_id`, `recipe_name`                                                       | Unfavorites a recipe                                                                                    |
| 64 | `recipe_mode_select`                    | Explore             | **Wired** | `mode`, `recipe_id`                                                              | `recipe_detail_screen.dart` — onModeSelected                                                            |
| 65 | `recipe_filter_apply`                   | Explore             | **Wired** | `meal_types`, `is_spicy`, `favorites_only`                                       | Applies recipe filters                                                                                  |
| 66 | `guide_category_view`                   | Explore             | **Wired** | `category_id`, `category_name`, `content_type`                                   | Opens guide category                                                                                    |
| 67 | `guide_video_play`                      | Explore             | **Wired** | `video_id`, `video_name`, `category_name`                                        | Plays guide video                                                                                       |
| 68 | `calculator_start`                      | Explore             | **Wired** | —                                                                                | Opens calorie calculator                                                                                |
| 69 | `calculator_complete`                   | Explore             | **Wired** | `goal`, `gender`, `age`, `activity_level`, `bmr`, `tdee`, `goal_calories`        | Sees calculator results                                                                                 |
| 70 | `program_history_view`                  | Explore             | **Wired** | —                                                                                | Opens training history                                                                                  |
| 71 | `explore_section_tap`                   | Explore             | **Wired** | `section_name`                                                                   | `explore_screen.dart` — onTap for catalog/history/guides/recipes                                        |
| 72 | `satiating_food_list_view`              | Explore             | **Wired** | —                                                                                | `satiating_food_list_screen.dart` — initState                                                           |
| 73 | `satiating_food_detail_view`            | Explore             | **Wired** | `food_id`, `food_name`, `food_category`                                          | `satiating_food_detail_screen.dart` — on data load                                                      |
| 74 | `satiating_food_favorite`               | Explore             | **Wired** | `food_id`, `food_name`, `is_favorite`                                            | `satiating_food_detail_screen.dart` — favorite toggle                                                   |
| 75 | `satiating_food_filter_apply`           | Explore             | **Wired** | `food_category`                                                                  | `satiating_food_list_screen.dart` — category chip tap                                                   |
|     | **RANKING / COMMUNITY**                 |                     |           |                                                                                  |                                                                                                         |
| 76 | `ranking_view`                          | Ranking             | Not wired | —                                                                                | Views ranking screen                                                                                    |
| 77 | `ranking_enrolled`                      | Ranking             | **Wired** | — (no params)                                                                    | Joins ranking (fires in `profile_providers.dart:149` after ranking onboarding)                          |
| 78 | `ranking_filter_change`                 | Ranking             | **Wired** | `filter_type`                                                                    | `community_screen.dart` — _onFilterTap()                                                                |
| 79 | `ranking_tutorial_completed`            | Ranking             | **Wired** | —                                                                                | `ranking_tutorial_screen.dart` — user views all 5 pages                                                 |
|     | **PROFILE**                             |                     |           |                                                                                  |                                                                                                         |
| 80 | `profile_view`                          | Profile             | Not wired | —                                                                                | Opens profile screen                                                                                    |
| 81 | `profile_field_update`                  | Profile             | **Wired** | `field_name`                                                                     | `profile_providers.dart` — updateProfile()                                                              |
| 82 | `profile_photo_change`                  | Profile             | **Wired** | —                                                                                | `profile_providers.dart` — uploadProfilePicture()                                                       |
|     | **ACTIVITY LOGGING**                    |                     |           |                                                                                  |                                                                                                         |
| 83 | `activity_create`                       | Activity            | **Wired** | `activity_type`, `duration_minutes`                                              | `activities_providers.dart` — createActivity()                                                          |
| 84 | `activity_delete`                       | Activity            | **Wired** | —                                                                                | `weekly_activity_log_section.dart`                                                                      |
|     | **APP ENGAGEMENT**                      |                     |           |                                                                                  |                                                                                                         |
| 85 | `tab_select`                            | Engagement          | **Wired** | `tab_name`                                                                       | Bottom nav tap (in `main_scaffold.dart:53`)                                                             |
| 86 | `share_content`                         | Engagement          | Not wired | —                                                                                | Any share action                                                                                        |
| 87 | `notification_received`                 | Engagement          | **Wired** | `notification_type`                                                              | `messaging_service.dart` — _handleForegroundMessage()                                                   |
| 88 | `notification_tap`                      | Engagement          | **Wired** | `notification_type`, `action`                                                    | `messaging_service.dart` — _handleMessageOpenedApp()                                                    |
|     | **SUBSCRIPTION / IAP**                  |                     |           |                                                                                  |                                                                                                         |
| 89 | `paywall_viewed`                        | Subscription        | **Wired** | `entry_point`                                                                    | User sees paywall screen                                                                                |
| 90 | `purchase_started`                      | Subscription        | **Wired** | `subscription_tier`, `product_id`                                                | User initiates purchase                                                                                 |
| 91 | `purchase_completed`                    | Subscription        | **Wired** | `subscription_tier`, `is_trial`, `product_id`                                    | Purchase verified                                                                                       |
| 92 | `purchase_cancelled`                    | Subscription        | **Wired** | `subscription_tier`                                                              | User cancels purchase flow                                                                              |
| 93 | `purchase_failed`                       | Subscription        | **Wired** | `subscription_tier`, `error_message`                                             | Purchase fails                                                                                          |
| 94 | `restore_attempted`                     | Subscription        | **Wired** | —                                                                                | User taps Restore Purchases                                                                             |
| 95 | `restore_completed`                     | Subscription        | **Wired** | —                                                                                | Restore succeeds                                                                                        |
| 96 | `restore_failed`                        | Subscription        | **Wired** | `error_message`                                                                  | Restore fails                                                                                           |
| 97 | `trial_banner_tapped`                   | Subscription        | **Wired** | `days_remaining`, `variant`                                                      | `trial_expiry_banner.dart`                                                                              |
|     | **ROUNDS (RONDAS v2)**                  |                     |           |                                                                                  |                                                                                                         |
| 98 | `rounds_session_started`                | Rounds              | **Wired** | `round_mode`, `round_count`, `time_limit`, `exercise_count`                      | `rounds_session_screen.dart` — session begins                                                           |
| 99 | `rounds_session_completed`              | Rounds              | **Wired** | `round_mode`, `rounds_completed`, `total_time_ms`                                | `rounds_session_screen.dart` — session saved                                                            |
| 100 | `rounds_session_abandoned`              | Rounds              | **Wired** | `round_mode`, `rounds_completed`, `round_count`                                  | `rounds_session_screen.dart` — partial save on back                                                     |
| 101 | `round_log_history_view`                | Rounds              | **Wired** | `round_mode`                                                                     | `round_log_history_screen.dart` — initState                                                             |
|     | **ERRORS**                              |                     |           |                                                                                  |                                                                                                         |
| 102 | `error_occurred`                        | Error               | Not wired | —                                                                                | Generic error                                                                                           |
| 103 | `network_error`                         | Error               | Not wired | —                                                                                | Network failure                                                                                         |
| 104 | `api_error`                             | Error               | Not wired | —                                                                                | API error response                                                                                      |
|     | **VIDEO BANNER (HOME)**                 |                     |           |                                                                                  |                                                                                                         |
| 105 | `video_banner_shown`                    | Home                | **Wired** | `video_id`, `video_title`, `user_type`, `days_shown`                             | `video_banner_card.dart` — once per widget instance when banner becomes visible                         |
| 106 | `video_banner_dismissed`                | Home                | **Wired** | `video_id`, `video_title`, `user_type`, `days_shown`                             | `video_banner_card.dart` — when banner expires (API returns `showBanner: false` after previously shown) |
| 107 | `video_opened`                          | Home                | **Wired** | `video_id`, `video_title`, `user_type`                                           | `video_banner_video_screen.dart` — initState (user taps banner, opens video)                            |
| 108 | `video_completed`                       | Home                | **Wired** | `video_id`, `video_title`, `user_type`, `seconds_watched`, `percent_watched`     | `video_banner_video_screen.dart` — video reaches the end                                                |
| 109 | `video_closed_early`                    | Home                | **Wired** | `video_id`, `video_title`, `user_type`, `seconds_watched`, `percent_watched`     | `video_banner_video_screen.dart` — user closes video before end (dispose)                               |
| 110 | `video_cta_shown`                       | Home                | **Wired** | `video_id`, `video_title`, `user_type`, `cta_type`                               | `video_banner_video_screen.dart` — CTA panel visible on screen open                                     |
| 111 | `video_cta_tapped`                      | Home                | **Wired** | `video_id`, `video_title`, `user_type`, `cta_type`                               | `video_banner_video_screen.dart` — CTA button pressed (`choose_program` or `motivation`)                |
| 112 | `video_cta_dismissed`                   | Home                | **Wired** | `video_id`, `video_title`, `user_type`, `cta_type`                               | `video_banner_video_screen.dart` — user closes screen without tapping CTA (dispose)                     |
|     | **TRAINING SCHEDULE**                   |                     |           |                                                                                  |                                                                                                         |
| 113 | `training_schedule_viewed`              | Training            | **Wired** | `is_editing`                                                                     | `training_schedule_screen.dart` — initState                                                             |
| 114 | `training_schedule_saved`               | Training            | **Wired** | `day_count`, `reminder_minutes`, `is_update`                                     | `training_schedule_screen.dart` — after successful save                                                 |
| 115 | `training_schedule_deleted`             | Training            | **Wired** | —                                                                                | `training_schedule_provider.dart` — delete()                                                            |
|     | **APP LIFECYCLE**                       |                     |           |                                                                                  |                                                                                                         |
| 116 | `app_open`                              | Lifecycle           | **Wired** | —                                                                                | `app_startup_provider.dart` — _initializePostAuth()                                                     |


**Summary by status**:

- **Wired** (sending data in production): 107 events
- **Not wired** (defined but no code calls it): 9 events (mostly error tracking, share, continuation views, ranking_view, profile_view)
- Remaining unwired events are low-priority or have no UI trigger
...
2. `**program_video_play**` — not wired (el vídeo de intro del programa se auto-reproduce; el screen_view ya cubre la pantalla)
...
> Nota: el viejo `onboarding_skip` (v1) ya no aplica; el flujo nuevo usa `onboarding_step_skipped`, que sí está wired.
...
| 4   | Onboarding Dropoff    | `onboarding_started` fired but NOT `onboarding_completed` | "Complete your setup to get started"       |
...
5. [Onboarding Events (flujo nuevo)](#3-onboarding-events-flujo-nuevo)
...
| **Reserved prefixes**        | Never use `ga`_, `firebase_`, `google_`                |
...
| `complete` | User finishes a flow   | `training_session_complete`, `onboarding_completed` |
...
| `onboarding_started`                    | `onboarding_step1_welcome_screen.dart`                |                                                                         |
| `onboarding_step_viewed`                | Cada `onboarding_stepN_*.dart`                        |                                                                         |
| `onboarding_step_completed`             | Cada `onboarding_stepN_*.dart`                        | Incluye `time_on_screen_ms`                                             |
| `onboarding_step_skipped`               | Welcome / permisos                                    |                                                                         |
| `onboarding_answer_selected`            | Steps cuestionario (3,4,6,7,8,9)                      | `field`, `value`                                                        |
| `onboarding_recommendation_fetched`     | `onboarding_step10_program_screen.dart`              | `had_error`, `latency_ms`                                               |
| `onboarding_program_selected`           | `onboarding_step10_program_screen.dart`              |                                                                         |
| `onboarding_register_attempt`           | `onboarding_step12_register_screen.dart`             |                                                                         |
| `onboarding_register_success`           | `onboarding_step12_register_screen.dart`             |                                                                         |
| `onboarding_register_failed`            | `onboarding_step12_register_screen.dart`             | `error_message`                                                         |
| `onboarding_paywall_viewed`             | `paywall_screen.dart` (entryPoint=onboarding)        |                                                                         |
| `onboarding_purchase_completed`         | `paywall_screen.dart` (entryPoint=onboarding)        |                                                                         |
| `onboarding_purchase_failed`            | `paywall_screen.dart` (entryPoint=onboarding)        |                                                                         |
| `onboarding_purchase_cancelled`         | `paywall_screen.dart` (entryPoint=onboarding)        |                                                                         |
| `onboarding_health_granted`             | `onboarding_step13_health_screen.dart`               |                                                                         |
| `onboarding_health_skipped`             | `onboarding_step13_health_screen.dart`               |                                                                         |
| `onboarding_notifications_granted`      | `onboarding_step15_notifications_screen.dart`        |                                                                         |
| `onboarding_notifications_skipped`      | `onboarding_step15_notifications_screen.dart`        |                                                                         |
| `onboarding_completed`                  | `onboarding_step15_notifications_screen.dart`        | total_time, flags                                                       |
| `onboarding_resumed`                    | `app_router.dart`                                    |                                                                         |
...
### 3. Onboarding Events (flujo nuevo)

**Status**: Flujo nuevo de **15 pantallas** (rama `feat/new-onboarding-flow`), instrumentado con el set de eventos `onboarding_*` y **enviando datos en producción desde 2026-05-11**. Sustituye al embudo v1 (`onboarding_start/complete/skip`) y al "Training Onboarding" v1 (`training_onboarding_*`, `program_*_intent_clicked`, `signup_*`), que correspondían a la pantalla antigua `ProgramFirstChoice` y ya no aplican.

> Fuente canónica del flujo y eventos: `onboarding_flow.md`. Implementación: `lib/features/onboarding/presentation/screens/onboarding_stepN_*.dart`.

**Flujo (15 pasos):**

```
1 Welcome → 2 Vídeo → 3 Datos personales → 4 Objetivo → 5 Prueba social
→ 6 Tipo de entreno → 7 Dónde entrenas → 8 Nivel → 9 Días/semana
→ 10 Programa recomendado → 11 Metodología → 12 Registro
→ 13 Permisos de salud → 14 Paywall → 15 Notificaciones → Home
```

**Eventos genéricos (en casi todos los pasos):**

| Event | Enum Value | Parameters | When Fired |
| ----- | ---------- | ---------- | ---------- |
| `onboarding_started` | `onboardingStarted` | `entry_point` (`cold_start`) | Step 1, al montar Welcome |
| `onboarding_step_viewed` | `onboardingStepViewed` | `step`, `step_name` | Al montar cada pantalla |
| `onboarding_step_completed` | `onboardingStepCompleted` | `step`, `step_name`, `time_on_screen_ms` | Al pulsar el CTA / avanzar |
| `onboarding_step_skipped` | `onboardingStepSkipped` | `step`, `step_name` | Al saltar (login, omitir permiso) |
| `onboarding_answer_selected` | `onboardingAnswerSelected` | `field`, `value` | Al elegir respuesta del cuestionario |
| `onboarding_resumed` | `onboardingResumed` | `step` | Al reanudar tras cierre de la app |
| `onboarding_completed` | `onboardingCompleted` | `total_time_ms`, `health_granted`, `notifications_granted`, `program_selected` | Step 15, al terminar → Home |

**Eventos por paso:**

| # | Pantalla (`step_name`) | Eventos propios | Parámetros |
| - | ---------------------- | --------------- | ---------- |
| 1 | Welcome (`welcome`) | `onboarding_started`, `onboarding_step_skipped` | `started`: `entry_point: cold_start`; `skipped` → `/login` |
| 2 | Vídeo intro (`video`) | — | CTA "Vamos" |
| 3 | Datos personales (`personal_info`) | `onboarding_answer_selected` ×2 | `field: gender`, `field: age` |
| 4 | Objetivo (`goal`) | `onboarding_answer_selected` | `field: goal` |
| 5 | Prueba social (`social_proof`) | — | Testimonios por género/edad |
| 6 | Tipo de entreno (`objective`) | `onboarding_answer_selected` | `field: objective` |
| 7 | Dónde entrenas (`training_place`) | `onboarding_answer_selected` | por card |
| 8 | Nivel (`experience`) | `onboarding_answer_selected` | Principiante / Avanzado |
| 9 | Días/semana (`days`) | `onboarding_answer_selected` | 2 / 3 / 4 / 5 |
| 10 | Programa recomendado (`program`) | `onboarding_recommendation_fetched`, `onboarding_program_selected` | `recommendation_fetched`: `primary_program_id`, `alternative_program_id`, `latency_ms`, `had_error`. `program_selected`: `program_id`, `is_alternative` |
| 11 | Metodología (`methodology`) | — | "El Método no es solo entrenar" |
| 12 | Registro (`register`) | `onboarding_register_attempt`, `onboarding_register_success`, `onboarding_register_failed` | `method` (`google`/`apple`/`email`); `success`: `time_on_screen_ms`; `failed`: `error_message` |
| 13 | Permisos de salud (`health`) | `onboarding_health_granted`, `onboarding_health_skipped`, `onboarding_step_skipped` | "Activa tu cuentapasos" |
| 14 | Paywall (`onboarding`) | `onboarding_paywall_viewed`, `onboarding_purchase_completed`, `onboarding_purchase_failed`, `onboarding_purchase_cancelled` | Reutiliza `PaywallScreen` con `entryPoint=onboarding` |
| 15 | Notificaciones (`notifications`) | `onboarding_notifications_granted`, `onboarding_notifications_skipped`, `onboarding_step_skipped` | Al terminar → `onboarding_completed` + navega a Home |

**Embudo esperado (un usuario que convierte):**

```
onboarding_started → onboarding_step_viewed (×15) → onboarding_answer_selected (steps 3,4,6,7,8,9)
→ onboarding_recommendation_fetched + onboarding_program_selected (10)
→ onboarding_register_attempt → onboarding_register_success (12)
→ onboarding_health_granted (13) → onboarding_paywall_viewed → onboarding_purchase_completed (14)
→ onboarding_notifications_granted (15) → onboarding_completed
```

Puntos de caída clave: salto en step 1 (`onboarding_step_skipped` → login), error de recomendación (`had_error: true` en step 10), fallo de registro (12) y abandono del paywall (`onboarding_purchase_cancelled`, 14).

**Implementación**: `lib/features/onboarding/presentation/screens/onboarding_stepN_*.dart`; eventos definidos en `lib/core/analytics/analytics_service.dart` (sección "New Onboarding Flow"). El reanudado lo dispara `lib/core/router/app_router.dart`.
...
| **Onboarding Dropoff**    | `onboarding_started` fired but NOT `onboarding_completed` | Re-engage incomplete onboarding |
...
| `lib/features/onboarding/presentation/screens/onboarding_stepN_*.dart`            | Onboarding (flujo nuevo) — todos los eventos `onboarding_*` |
| `lib/core/router/app_router.dart`                                                 | `onboarding_resumed` (reanudación)              |
